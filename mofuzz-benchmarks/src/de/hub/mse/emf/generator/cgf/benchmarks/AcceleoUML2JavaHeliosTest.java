...
public class AcceleoUML2JavaHeliosTest {
    ...
    @Fuzz
    public void simpleGeneratorTest(@From(CoverageGuidedUMLGenerator.class) Resource resource) {
    	Model model = (Model) EcoreUtil.getObjectByType(resource.getContents(), UMLPackage.Literals.MODEL);
    	ResourceSet set = resource.getResourceSet();
    	Random random = new Random();
		File targetFolder = new File("workdirs/emfgen_cgf_uml2java_out" + random.nextInt());
