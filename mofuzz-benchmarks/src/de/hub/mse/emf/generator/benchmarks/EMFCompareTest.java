...
public class EMFCompareTest {
	...
	@Fuzz
	public void simpleCopyTest(@From(UMLGenerator.class) Resource resource) {
	...
	@Fuzz
	public void copyAllRightToLeft(@From(UMLGenerator.class) Resource resource1, @From(UMLGenerator.class) Resource resource2) {
	...
	@Fuzz
	public void copyAllLeftToRight(@From(UMLGenerator.class) Resource resource1, @From(UMLGenerator.class) Resource resource2) {
		Model model1 = (Model) EcoreUtil.getObjectByType(resource1.getContents(), UMLPackage.Literals.MODEL);
        Assert.assertNotNull(model1);
        removeAllDuplicateCrossReferencesFrom(model1);
        EObject backup = EcoreUtil.copy(model1);
	...
	@Fuzz
	public void diffTest(@From(UMLGenerator.class) Resource resource) {
