...
public class EMFCompareTest {
	...
	@Fuzz
	public void simpleCopyTest(@From(GuidedSERGeUMLGenerator.class) Resource resource) {
	...
	@Fuzz
	public void copyAllRightToLeft(@From(GuidedSERGeUMLGenerator.class) Resource resource1, @From(GuidedSERGeUMLGenerator.class) Resource resource2) {
	...
	@Fuzz
	public void copyAllLeftToRight(@From(GuidedSERGeUMLGenerator.class) Resource resource1, @From(GuidedSERGeUMLGenerator.class) Resource resource2) {
		Model model1 = (Model) EcoreUtil.getObjectByType(resource1.getContents(), UMLPackage.Literals.MODEL);
        Assert.assertNotNull(model1);
        removeAllDuplicateCrossReferencesFrom(model1);
        EObject backup = EcoreUtil.copy(model1);
	...
	@Fuzz
	public void mergeTest(@From(GuidedSERGeUMLGenerator.class) Resource resource) {
	...
	@Fuzz
	public void diffTest(@From(GuidedSERGeUMLGenerator.class) Resource resource) {
    	Model model1 = (Model) EcoreUtil.getObjectByType(resource.getContents(), UMLPackage.Literals.MODEL);
        Assert.assertNotNull(model1);
        removeAllDuplicateCrossReferencesFrom(model1);
        EObject backup = EcoreUtil.copy(model1);
