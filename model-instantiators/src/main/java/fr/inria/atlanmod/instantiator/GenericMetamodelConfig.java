...
public class GenericMetamodelConfig implements ISpecimenConfiguration {
	 ...
	 */
	public GenericMetamodelConfig(MetamodelResource metamodelResource, Range<Integer> elementsRange, long seed) {
		super();
	 ...
	 *            {@link SpecimenGenerator} will create instances
	 */
	public GenericMetamodelConfig(MetamodelResource resource, Range<Integer> elementsRange) {
